...
export default function () {
  ...
  const testUserId =
    __ENV.TEST_USER_ID || "07fa091c-ee40-4f0d-a3d4-34353b7bb129";
...
export function handleSummary(data) {
  ...
  console.log(
    `✅ Latence p95: ${p95.toFixed(2)}ms (seuil: 1000ms) ${p95 < 1000 ? "✅" : "❌"}`
  );
  console.log(
    `✅ Taux d'erreur: ${errorRateValue.toFixed(2)}% (seuil: 10%) ${errorRateValue < 10 ? "✅" : "❌"}`
  );
  console.log("=".repeat(80) + "\n");
